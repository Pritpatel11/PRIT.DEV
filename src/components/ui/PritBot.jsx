...
const PritBot = () => {
    ...
    return (
        <div className="fixed bottom-8 left-24 z-[100]">
                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <div className="bg-cyber-purple/10 border-b border-white/10 p-4 flex items-center justify-between">
                            ...
                            <button aria-label="Close Bot" onClick={() => setIsOpen(false)} className="opacity-40 hover:opacity-100 transition-opacity">
                                <X size={16} />
                            </button>
                        </div>
            ...
            <button
                aria-label={isOpen ? "Close AI Bot" : "Open AI Bot"}
