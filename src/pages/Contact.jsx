                        ...
                        <div className="bg-[#0c0c0c] rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
                            ...
                            <div className="p-6 md:p-8 font-mono text-sm">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-8">
                                    <div className="space-y-2">
                                        <label htmlFor="contact-name" className="text-[10px] font-bold text-cyber-blue tracking-widest block uppercase cursor-pointer hover:text-cyber-blue/80 transition-colors">NAME &gt;</label>
                                        <input
                                            id="contact-name"
                                            type="text"
                                            required
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="contact-email" className="text-[10px] font-bold text-cyber-blue tracking-widest block uppercase cursor-pointer hover:text-cyber-blue/80 transition-colors">EMAIL &gt;</label>
                                        <input
                                            id="contact-email"
                                            type="email"
                                            required
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="contact-message" className="text-[10px] font-bold text-cyber-blue tracking-widest block uppercase cursor-pointer hover:text-cyber-blue/80 transition-colors">MESSAGE &gt;</label>
                                        <textarea
                                            id="contact-message"
                                            required
                                            rows="4"
