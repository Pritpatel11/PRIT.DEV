                        ...
                        <div className="bg-[#0c0c0c] rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
                            ...
                            <div className="p-6 md:p-8 font-mono text-sm">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-8">
                                    <div className="space-y-2">
                                        <label htmlFor="name" className="text-[10px] font-bold text-cyber-blue tracking-widest block uppercase cursor-pointer w-fit">NAME &gt;</label>
                                        <input
                                            id="name"
                                            type="text"
                                            required
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="text-[10px] font-bold text-cyber-blue tracking-widest block uppercase cursor-pointer w-fit">EMAIL &gt;</label>
                                        <input
                                            id="email"
                                            type="email"
                                            required
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="message" className="text-[10px] font-bold text-cyber-blue tracking-widest block uppercase cursor-pointer w-fit">MESSAGE &gt;</label>
                                        <textarea
                                            id="message"
                                            required
                                            rows="4"
